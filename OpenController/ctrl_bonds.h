...
// and `esb/bond_2` (slot 1). We mirror that: two slots, each holding the 24-byte bond record
...
// matches the puck's E1 host frame at reconnect. Persists to LittleFS `/ctrlbond.bin`.
#pragma once
#include <stdint.h>
